...
<<<<<<< HEAD
        string strDesc = "sandy " + FormatFullVersion();
=======
...
<<<<<<< HEAD
            strError = strprintf(_("Unable to bind to %s on this computer. sandy is probably already running."), addrBind.ToString().c_str());
=======
