...
<<<<<<< HEAD
    bool fEnforceBIP30 = true; // Always active in sandy
    bool fStrictPayToScriptHash = true; // Always active in sandy
=======
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
<<<<<<< HEAD
        uiInterface.ThreadSafeMessageBox(strMessage, "sandy", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
=======
