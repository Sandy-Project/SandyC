    ...
    rpcConsole(0)
{
    resize(850, 550);
<<<<<<< HEAD
    setWindowTitle(tr("sandy") + " - " + tr("Wallet"));
=======
...
<<<<<<< HEAD
    sendCoinsAction->setToolTip(tr("Send coins to a sandy address"));
=======
...
<<<<<<< HEAD
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About sandy"), this);
    aboutAction->setToolTip(tr("Show information about sandy"));
=======
...
<<<<<<< HEAD
    optionsAction->setToolTip(tr("Modify configuration options for sandy"));
=======
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            {
<<<<<<< HEAD
                trayIcon->setToolTip(tr("sandy client") + QString(" ") + tr("[testnet]"));
=======
...
<<<<<<< HEAD
    trayIcon->setToolTip(tr("sandy client"));
=======
...
<<<<<<< HEAD
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid sandy address or malformed URI parameters."));
=======
